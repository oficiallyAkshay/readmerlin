...
Order of work: `context`, `rules`, scope the Fit lists, find the In action result, draw the hero with figurehead, write the parts in order, compare truthfully, write the docs pages, `check --pages` until clean, `init-workflow`.
