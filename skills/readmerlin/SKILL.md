...
10. Check. Run `readmerlin check --pages` and fix every fail. Repeat until clean. A green check is the floor, not the standard: hold the README to the section shape as well. Warnings are judgment calls; mention them, do not silently accept them.
