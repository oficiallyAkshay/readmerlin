...
1. Gather. Run `readmerlin context --format md` and read what it prints. It lists the skills, commands, agents, manifests, hosts, workflows, the badge row, the compare spec and the existing README in full. When it says this is the product's own page, follow that. Do not walk the source tree.
